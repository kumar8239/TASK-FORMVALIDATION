...
export default function MCL() {
  return (
    <div>
        <Card style={{ width: '80rem',height:'500px',border:"none" }} className="mx-2 mt-4 card_style" >
            <div  className="card-body"style={{textAlign:'center'}}>
                <div className="card-body">
                    <h1 className="card-title" >MV Lorem, ipsum dolor.</h1>
                    <h3 className="card-subtitle mb-2 text-body-secondary">WCL |  TUNA FORT  |  5096 NAR(KCAL/KG)</h3>
